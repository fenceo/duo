...
async function choose(id:string,view='chat'){
 if(!mayLeave())return;chosen=id;const token=++selection;detail=null;dirty=false;sequence=0;resetConversation();void loadStickyBoard();taskContext=[];void loadTaskContext(id);
